...
privileged aspect Country_Roo_Jpa_ActiveRecord {
    ...
    public static Country Country.findCountry(String isoAlpha2) {
        if (isoAlpha2 == null || isoAlpha2.length() == 0) return null;
        return entityManager().find(Country.class, isoAlpha2);
    }
    ...
    public void Country.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Country attached = Country.findCountry(this.isoAlpha2);
