...
public class Player {
	...
	public String toString() {
        return new ReflectionToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).setExcludeFieldNames("languages", "achieveds", "boardgames", "playeds", "sex", "levelId", "country").toString();
    }
}
