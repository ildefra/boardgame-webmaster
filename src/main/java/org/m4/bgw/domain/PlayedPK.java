...
public static PlayedPK fromJsonToPlayedPK(String json) {
    return new JSONDeserializer<PlayedPK>().use(null, PlayedPK.class).deserialize(json);
}
...
public static Collection<PlayedPK> fromJsonArrayToPlayedPKs(String json) {
    return new JSONDeserializer<List<PlayedPK>>().use("values", PlayedPK.class).deserialize(json);
}


@Override
public boolean equals(Object obj) {
    if (!(obj instanceof PlayedPK)) { return false; }
