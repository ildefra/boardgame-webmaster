...
public Integer getBoardgameId() {return boardgameId; }
...
public static AchievedPK fromJsonToAchievedPK(String json) {
    return new JSONDeserializer<AchievedPK>().use(null, AchievedPK.class).deserialize(json);
}
...
public boolean equals(Object obj) {
    if (!(obj instanceof AchievedPK)) { return false; }
