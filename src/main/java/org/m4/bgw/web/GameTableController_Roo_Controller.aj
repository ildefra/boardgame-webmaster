...
privileged aspect GameTableController_Roo_Controller {
    ...
    @Autowired
    GameTableRepository GameTableController.gameTableRepository;
    
    @Autowired
    BoardgameRepository GameTableController.boardgameRepository;
    
    @Autowired
    PlayedRepository GameTableController.playedRepository;
    
    @Autowired
    TimeLimitRepository GameTableController.timeLimitRepository;
