...
privileged aspect PlayerController_Roo_Controller {
    ...
    @Autowired
    AchievedRepository PlayerController.achievedRepository;
    
    @Autowired
    BoardgameRepository PlayerController.boardgameRepository;
    
    @Autowired
    CountryRepository PlayerController.countryRepository;
    
    @Autowired
    GenderRepository PlayerController.genderRepository;
    
    @Autowired
    LanguageRepository PlayerController.languageRepository;
    
    @Autowired
    PlayedRepository PlayerController.playedRepository;
    
    @Autowired
    UserLevelRepository PlayerController.userLevelRepository;
