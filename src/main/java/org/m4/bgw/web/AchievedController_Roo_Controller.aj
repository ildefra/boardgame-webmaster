...
privileged aspect AchievedController_Roo_Controller {
    ...
    @Autowired
    AchievedRepository AchievedController.achievedRepository;
    
    @Autowired
    AchievementRepository AchievedController.achievementRepository;
    
    @Autowired
    BoardgameRepository AchievedController.boardgameRepository;
    
    @Autowired
    PlayerRepository AchievedController.playerRepository;
