...
CREATE TABLE IF NOT EXISTS `country` (
  `country_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
  `name` VARCHAR(50) NOT NULL COMMENT '',
  `alpha_2` CHAR(2) NOT NULL COMMENT '',
  `alpha_3` CHAR(3) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `player` (
  `player_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
...
CREATE TABLE IF NOT EXISTS `publisher` (
  ...
  UNIQUE INDEX `id_UNIQUE` (`publisher_id` ASC)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `game_tag` (
  `game_tag_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
  `name` VARCHAR(20) NOT NULL COMMENT '',
  UNIQUE INDEX `name_UNIQUE` (`name` ASC)  COMMENT '',
  PRIMARY KEY (`game_tag_id`)  COMMENT '',
  UNIQUE INDEX `game_tag_id_UNIQUE` (`game_tag_id` ASC)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `achieved` (
  ...
  INDEX `achieved_has_player_fk1_idx` (`player_id` ASC)  COMMENT '',
  ...
  CONSTRAINT `has_achievement_has_achievement_fk1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `achieved_has_player_fk1`
...
CREATE TABLE IF NOT EXISTS `has_tag` (
  ...
  PRIMARY KEY (`boardgame_id`, `game_tag_id`)  COMMENT '',
  INDEX `boardgame_game_tag_has_game_tag_fk1_idx` (`game_tag_id` ASC)  COMMENT '',
  INDEX `boardgame_game_tag_has_boardgame_fk1_idx` (`boardgame_id` ASC)  COMMENT '',
  CONSTRAINT `boardgame_game_tag_has_boardgame_fk1`
    FOREIGN KEY (`boardgame_id`)
    REFERENCES `boardgame` (`boardgame_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `boardgame_game_tag_has_game_tag_fk1`
...
CREATE TABLE IF NOT EXISTS `played` (
  ...
  PRIMARY KEY (`player_id`, `game_table_id`)  COMMENT '',
  INDEX `player_game_table_has_game_table_fk1_idx` (`game_table_id` ASC)  COMMENT '',
  INDEX `player_game_table_has_player_fk1_idx` (`player_id` ASC)  COMMENT '',
  CONSTRAINT `player_game_table_has_player_fk1`
    FOREIGN KEY (`player_id`)
    REFERENCES `player` (`player_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `player_game_table_has_game_table_fk1`
