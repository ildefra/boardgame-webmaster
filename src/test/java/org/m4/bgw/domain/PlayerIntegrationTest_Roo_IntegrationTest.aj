...
import org.m4.bgw.domain.PlayerIntegrationTest;
...
privileged aspect PlayerIntegrationTest_Roo_IntegrationTest {
    ...
    public void PlayerIntegrationTest.testFindPlayer() {
        ...
        Assert.assertEquals("Find method for 'Player' returned the incorrect identifier", id, obj.getUsername());
    }
    ...
    public void PlayerIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Player' identifier to be null", obj.getUsername());
        try {
            obj.persist();
        ...
        obj.flush();
        Assert.assertNotNull("Expected 'Player' identifier to no longer be null", obj.getUsername());
    }
